...
A telegram bot that helps you to search bible verses. It uses
[BibleGateway](https://biblegateway.com) to get the bible verses and is built
using [pyTelegramBotAPI](https://pytba.readthedocs.io/en/latest/).

## Commands

- `/start` : Starts the bot.
- `/help` : Displays information about how to use the bot.
- `/verse` : Send a bible verse after this command and the bot will reply with
  the full verse.
