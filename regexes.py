...
full_chapter_num_regex = re.compile(r"\b(?!chapter|verse|to\b)(?:\w+?|gr?e?e?k esth?e?r?|addi?t?i?o?n?s? *(?:to)? *esth?e?r?|(?:lett?e?r?|ep) *(?:of)? *jere?m?i?a?h?) *\d[\d,; \-]*(?! :|:)\b ?(?:rcu17[ts]s|[A-Za-z\-]*)?")
